...
public class PerformanceCodeIntegrator extends BaseCodeIntegrator {
    ...
    private static final String LOG_START = PROVIDED_LOGGER + ".debug(\"Execution started at: \" + java.lang.String" +
            ".valueOf(startTime));";
    private static final String LOG_STOP = PROVIDED_LOGGER + ".debug(\"Execution stopped at: \" + java.lang.String" +
            ".valueOf(stopTime));";
    private static final String LOG_TIME_DIFF = PROVIDED_LOGGER + ".debug(\"Execution took \" + java.lang.String" +
            ".valueOf(stopTime - startTime) + \" ms\");";
     ...
     *
     * @param ctMethod method to be modified
