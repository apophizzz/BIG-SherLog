...
public interface JmxInstrumentationServiceMBean {
	...
	/**
	 * Performs an sherlog and applies bytecode changes with respect to
	 * the transformation settings.
	 *
	 * @param className
	 *            name of the class the sherlog should be applied to
	 * @param methodName
	 *            name of the method the sherlog should be applied to
	 * @param methodSignature
	 *            signature of the method the sherlog should be applied
